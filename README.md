...
> ✅ **آخر تحقق شامل (r23 — سبتمبر 2026):** سلايدر «مرحباً بالعالم» بـ77 لغة في البطل + محافظات ومقاطعات 195 دولة في بطاقة العميل (فلسطين بلا إسرائيل) + تصدير/استيراد العملاء بالأعمدة الجديدة — مراجعة E2E بالمتصفح عربي/إنجليزي، جوال 393px بلا overflow، lint نظيف. التفاصيل في [منجز حديثاً](#-منجز-حديثاً).
