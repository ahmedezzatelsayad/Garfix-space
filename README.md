...
> ✅ **آخر تحقق شامل (r19 — سبتمبر 2026):** نشر نظيف من clone المستودع على بيئة جديدة (بناء البنية التحتية من الصفر) ومراجعة E2E بالمتصفح لكل المسارات الحرجة أعلاه — كل الخدمات الخمس تعمل، الكاش متصل فعلياً عبر Valkey، صفر أخطاء console، و`bun run lint` نظيف. التفاصيل في [منجز حديثاً](#-منجز-حديثاً).
